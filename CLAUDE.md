...
pipeline — twelve rule books extracted into 818 rules, 2,607 cards, 571 of them served. What is left
of the Trainer is its UI (`ts-fsrs` is still deferred). Session 10 built Utilities' first tool: the
...
| Modules         | **Law Converter, Pay & Allowances and the Drafting Studio are built** (rows above and below). Utilities has its first real tool, the glossary (row below); its other tools are still `ModulePlaceholder`-style content behind `UtilsHubPage`'s "coming later" cards. Trainer is still a placeholder page                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
