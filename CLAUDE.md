...
What is left of the Trainer is its UI — nothing imports `src/lib/srs` yet, so `ts-fsrs` is in no
chunk. Session 10 built Utilities' first tool: the
...
Studio's own glossary sheet and a `useGlossarySuggest` hook in its body editor. Utilities' other tools
(holiday calendar, leave, pension, portals directory) are still to build.**
...
| i18n            | 653 keys × {en, hi}, typed via module augmentation, `fallbackLng: false`. Nav labels live in `src/lib/nav.ts` as `{ en, hi }`. The `pay.*` block is still the largest single one (186 keys), with `draft.*` (151, after Session 10's mode-toggle and glossary-suggestion strings) next and `law.*` behind it; a new top-level `utils.*` block (27 keys — the glossary UI and the hub's tool cards, separate from `pages.utils.*`'s chrome) is the newest; the AI consent copy is still the largest block of prose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Persistence     | Dexie v6: `settings`, `secrets` / `aiAnswers` / `aiUsage` (AI, empty until turned on), `lawFavourites` / `lawRecents`, `payScenarios` (up to 10 named, and an eleventh is refused rather than evicting one), `drafts` (uncapped — a draft is work, not a comparison set — with an undoable delete), `draftDefaults` (one saved letterhead per form) and `glossaryFavourites` / `glossaryRecents` (Session 10, the same `{id, createdAt}` / `{id, viewedAt}` shape the law tables use). Settings rows: language, theme, `ai`, `pay` (the last scenario). Store hydrates from it and tolerates blocked storage, and Dexie v7's four trainer tables — `srsCards` (keyed `qId`, indexed on `due`), append-only `reviewLog`, `streaks` (keyed on an **IST** date) and a one-row `trainerSettings`. Their row shapes are declared in `src/lib/srs/types.ts` and imported here as types (ADR-025)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Modules         | **Law Converter, Pay & Allowances and the Drafting Studio are built** (rows above and below). Utilities has its first real tool, the glossary (row below); its other tools are still `ModulePlaceholder`-style content behind `UtilsHubPage`'s "coming later" cards. Trainer has its data and now its scheduler; its page is still `ModulePlaceholder`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
