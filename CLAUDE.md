...
| Tests         | 222 unit across 10 files (2 skip without a build) + 19 Playwright e2e (offline shell, zero third-party requests, axe × 2 languages × 2 themes, light-default theme, real rendered fonts, bottom-bar keyboard/IDREF/breakpoint edge cases)                                                  |
