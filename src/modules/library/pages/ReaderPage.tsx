...
import { adjacent, estimateReadTime, getUnit, recordProgress, toggleBookmark, unitLabel } from '@/lib/library'
...
export default function ReaderPage() {
  ...
  if (work.status === 'loading' || corpus.status === 'loading' || bookmarked === undefined) {
    return (
  ...
  const readMinutes = estimateReadTime([...unit.body.en, ...unit.body.hi].join(' '), language)
  const isBookmarked = bookmarked.has(unit.id)
